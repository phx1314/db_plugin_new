...
public class DialogSave extends LayoutRead {
    public DialogSave(VirtualFile file, MainFastRead mfr) throws Exception {
        super(file, mfr);
    }
    ...
    public void save() throws Exception {
        ...
        String packagenames = this.mainFastRead.getAppackageName() + ".dialog";
        this.mAutoCode.dianame = this.classname;
        this.mAutoCode.diapackage = packagenames;
        ...
        ts.save("androidTemplate/android_dialog_model.tpl", cfile);
    }
}
