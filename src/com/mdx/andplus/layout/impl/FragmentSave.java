...
public class FragmentSave extends LayoutRead {
    public FragmentSave(VirtualFile file, MainFastRead mfr) throws Exception {
        super(file, mfr);
    }
    ...
    public void save() throws Exception {
        ...
        String packagenames = this.mainFastRead.getAppackageName() + ".frg";
        this.mAutoCode.frgname = this.classname;
        this.mAutoCode.frgpacage = packagenames;
        ...
        if (cfile == null || !cfile.exists()) {
            ...
            ts.save("androidTemplate/android_fragment_model_kt.tpl", cfile);
        }
