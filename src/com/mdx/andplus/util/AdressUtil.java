...
public class AdressUtil {
    private final static String[] name = { "zuo", "zun", "zui", "zuan", "zu", "zou",
            ...
            "ai", "a" };
    private final static int[] code = { -10254, -10256, -10260, -10262, -10270, -10274,
    ...
    private static String getPinyin(char gb2312) {
    ...
    public static String getFirstSpell(String gb2312){
        if (null == gb2312 || "".equals(gb2312.trim())) {
            return gb2312;
        }
        char[] chars = gb2312.toCharArray();
    ...
    private static String getSpellByAscii(int ascii) {
        ...
        { // 单字符
            return String.valueOf((char) ascii).equals("?")?"_":String.valueOf((char) ascii);
        }
    ...
    public static void main(String[] args) {
        System.out.println("-------------------------------");
        System.out.println("全拼："+ AdressUtil.getPinyin("北京昌平"));
    }
}